...
<nav class="navbar">
<div class="navbar navbar-expand-lg bg-body-tertiary bg-dark d-flex p-0 row" data-bs-theme="dark">
    <div class="container-fluid nav-bar-custom">
        <img src="img/Logo/logo_transparent.png" alt="LOGO" class="col-2 d-none d-md-flex">
        <img src="img/Logo/logo_transparent.png" alt="LOGO" class="col-4 d-md-none">
        ...
        <ul class="navbar-nav me-auto mb-lg-0 d-none d-md-flex">
                <li class="nav-item m-5 d-flex justify-content-center">
                    <a class="nav-link link-active" aria-current="page" href="index.php">ACCUEIL</a>
                </li>
                <li class="nav-item m-5 d-flex justify-content-center">
...
<!-- MOBILE -->
<div class="collapse navbar-collapse nav_custom_mobile" id="navbarTogglerDemo01">
